                ...
                <FormikProvider value={formik}>
                    <form onSubmit={handleSubmit}>
                        <StyledContentContainer>
                            ...
                            <StyledSubtitle>
                                This simulator is optimized for use with a
                                minimum monthly traffic of 100,000
                            </StyledSubtitle>
                            <StyledRowContainer>
                                ...
                                <Stack>
                                    ...
                                    <StyledButton
                                        clickType="Start hooxing button"
                                        variant="contained"
                            ...
                            <StyledDisclaimer>
                                * Projected increases are estimates based on own
                                algorithms and industry benchmarks. Actual
                                outcomes may vary. Hoox does not guarantee
                                specific results.
                            </StyledDisclaimer>
                        </StyledContentContainer>
                    </form>
